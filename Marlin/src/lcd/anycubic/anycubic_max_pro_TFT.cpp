...
#elif ALL(ANYCUBIC_SOFT_TFT_MODEL_OLD, EXTENSIBLE_UI, ANYCUBIC_TFT_SERIAL)
...
void AnycubicTFTClass::HandleSpecialMenu()
{
  ...
  else if (STRCASECMP_P(_selectedDirectory, MENU_FANON)==0) {
    DEBUG_PRINT_LNPGM("Special Menu: Fan On");
    INJECT_CMD_NOW_PGM("M106 S255");
    _isLastUserActionRefresh = true;
  }
  else if (STRCASECMP_P(_selectedDirectory, MENU_FANOFF)==0) {
    DEBUG_PRINT_LNPGM("Special Menu:Fan Off");
