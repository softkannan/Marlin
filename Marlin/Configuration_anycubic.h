...
*/
  ...
  #define ANYCUBIC_TFT_MODEL
    ...
    //#define ANYCUBIC_POWER_LOSS_RECOVERY  // Power off and on

    #ifdef ANYCUBIC_GENERIC_SERIAL
      #if MOTHERBOARD == BOARD_TRIGORILLA_14_11
        #define INTERNAL_SERIAL_PORT 3
      #elif MOTHERBOARD == BOARD_BTT_SKR_V1_3
        #undef SERIAL_PORT_2  
      #endif
    #else
 ...
 */
  ...
  #define POWER_OFF_PIN 	    21 // One cable goes from power module to D21 pin and nearby 12V and GND pins
    ...
    #define OUTAGETEST_PIN       79  // Need to verify, these pins are not at all used by trigorilla board
    #define OUTAGECON_PIN        58  // Need to verify, these pins are not at all used by trigorilla board
  #endif
